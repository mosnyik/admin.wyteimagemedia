        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#45B7A8] to-[#2D9B88] hover:from-[#3a9a95] hover:to-[#268876] text-white font-semibold py-2 px-4 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-slate-600 text-sm mt-6">
            ...
            <Link href="/signup" className="text-[#45B7A8] hover:text-[#2D9B88] font-semibold">
              Sign up
            </Link>
          </p>
        </div>
